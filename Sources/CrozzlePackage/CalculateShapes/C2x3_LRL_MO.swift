                    ...
                    for left1 in 0..<wordCount {
                        ...
                        if (W.Len[left1] >= interlockWidth &&
                            ...
                            for outery2 in 0..<wordCount {
                                ...
                                let outery2Limit: Int = Int(W.Len[outery2] - 2)
                                for outery2Pos in 1..<outery2Limit {
                                    if (W.Len[outery2] >= interlockHeight + 2 &&
                                        W.Start[outery2][outery2Pos] == W.End[left1][0] &&
                                            ...
                                            for left3 in 0..<wordCount {
                                                ...
                                                if (W.Len[left3] >= interlockWidth &&
                                                    ...
                                                    if phase == 0 {
                                                        ...
                                                        let outerIndex = index + 4
                                                        outerStart[outerIndex] = UInt8(outery2Pos)
                                                        
                                                        
                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, right2, left3, middley1, outery2])
