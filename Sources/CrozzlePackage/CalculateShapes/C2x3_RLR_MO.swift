                       ...
                       if (W.Len[right1] >= interlockWidth &&
                           ...
                           for outery2 in 0..<wordCount {
                               ...
                               if W.Len[outery2] >= interlockHeight + 2 {
                                   let outery2Limit: Int = Int(W.Len[outery2]) - Int(interlockHeight)
                                   for outery2Pos in 1..<outery2Limit {
                                       if (W.Start[outery2][outery2Pos] == W.Start[right1][1] &&
                                                   ...
                                                   for right3 in 0..<wordCount {
                                                       ...
                                                       if (W.Len[right3] >= interlockWidth &&
                                                           ...
                                                           if phase == 0 {
                                                               ...
                                                               ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, left2, right3, middley1, outery2])
