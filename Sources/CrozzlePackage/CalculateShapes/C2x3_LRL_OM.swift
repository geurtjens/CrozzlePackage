   ...
   public static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
       ...
       for phase in 0..<2 {
           ...
           for outery1 in 0..<wordCount {
               // We moved the length to the top and changed the outery1Limit
               if W.Len[outery1] >= interlockHeight + 2 { // This is the minimum we can do if we want an outer across a 2x3
