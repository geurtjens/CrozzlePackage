       ...
       for phase in 0..<2 {
           ...
           for outery1 in 0..<wordCount {
               ...
               if W.Len[outery1] >= interlockHeight + 2 {
                   let outery1Limit: Int = Int(W.Len[outery1]) - Int(interlockHeight)
                   for outery1Pos in 1..<outery1Limit {
                       if (W.Len[outery1] >= interlockHeight) {
                                                   ...
                                                   for right3 in 0..<wordCount {
                                                       ...
                                                       if (W.Len[right3] >= interlockWidth &&
                                                           ...
                                                           if phase == 0 {
                                                               ...
                                                               ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, left2, right3, outery1, middley2])
