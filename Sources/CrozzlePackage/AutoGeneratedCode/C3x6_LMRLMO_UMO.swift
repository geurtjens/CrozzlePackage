                                                                                            ...
                                                                                            for outerx6Pos in 1..<outerx6Limit {
                                                                                                ...
                                                                                                W.Id[outerx6] != W.Id[up1]) {
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, middlex2, right3, left4, middlex5, outerx6, up1, middley2, outery3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
