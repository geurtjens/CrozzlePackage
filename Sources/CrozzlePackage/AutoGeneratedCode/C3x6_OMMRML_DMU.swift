                                                                                    ...
                                                                                    for left6 in 0..<wordCount {
                                                                                        ...
                                                                                        if (W.Len[left6] >= interlockWidth &&
                                                                                            ...
                                                                                            if phase == 0 {
                                                                                                ...
                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, middlex3, right4, middlex5, left6, down1, middley2, up3])
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
