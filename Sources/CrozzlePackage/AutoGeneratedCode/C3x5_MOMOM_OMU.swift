public class C3x5_MOMOM_OMU {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                                        ...
                                                                                        for middlex5 in 0..<wordCount {
                                                                                            ...
                                                                                            if (W.Len[middlex5] == interlockWidth &&
                                                                                                ...
                                                                                                if phase == 0 {
                                                                                                    ...
                                                                                                    ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [middlex1, outerx2, middlex3, outerx4, middlex5, outery1, middley2, up3])
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.middle, .outer, .middle, .outer, .middle],
