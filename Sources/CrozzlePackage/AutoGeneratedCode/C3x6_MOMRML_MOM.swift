public class C3x6_MOMRML_MOM {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                                            ...
                                                                                            for left6 in 0..<wordCount {
                                                                                                ...
                                                                                                if (W.Len[left6] >= interlockWidth &&
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [middlex1, outerx2, middlex3, right4, middlex5, left6, middley1, outery2, middley3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.middle, .outer, .middle, .trailing, .middle, .leading],
