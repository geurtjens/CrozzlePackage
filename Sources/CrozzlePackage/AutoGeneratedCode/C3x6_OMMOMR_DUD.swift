public class C3x6_OMMOMR_DUD {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                    ...
                                                                    for outerx4 in 0..<wordCount {
                                                                        ...
                                                                        if W.Len[outerx4] >= interlockWidth + 2 {
                                                                            ...
                                                                            for outerx4Pos in 1..<outerx4Limit {
                                                                                ...
                                                                                W.Start[outerx4][outerx4Pos + 1] == W.End[up2][2] &&
                                                                                            ...
                                                                                            for right6 in 0..<wordCount {
                                                                                                ...
                                                                                                if (W.Len[right6] >= interlockWidth &&
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, middlex3, outerx4, middlex5, right6, down1, up2, down3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.outer, .middle, .middle, .outer, .middle, .trailing],
