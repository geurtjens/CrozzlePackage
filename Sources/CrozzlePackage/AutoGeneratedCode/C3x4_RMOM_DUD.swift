public class C3x4_RMOM_DUD {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                ...
                                if (W.Len[up2] >= interlockHeight &&
                                    ...
                                    for middlex2 in 0..<wordCount {
                                        ...
                                        if (W.Len[middlex2] == interlockWidth &&
                                            ...
                                            W.Start[middlex2][1] == W.End[up2][2] &&
                                                    ...
                                                    for outerx3 in 0..<wordCount {
                                                        ...
                                                        if W.Len[outerx3] >= interlockWidth + 2 {
                                                            ...
                                                            for outerx3Pos in 1..<outerx3Limit {
                                                                ...
                                                                W.Start[outerx3][outerx3Pos + 1] == W.End[up2][1] &&
                                                                ...
                                                                W.Id[outerx3] != W.Id[down1]) {
                                                                    ...
                                                                    for middlex4 in 0..<wordCount {
                                                                        ...
                                                                        if (W.Len[middlex4] == interlockWidth &&
                                                                            ...
                                                                            W.Start[middlex4][1] == W.End[up2][0] &&
                                                                            ...
                                                                            if phase == 0 {
                                                                                ...
                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, middlex2, outerx3, middlex4, down1, up2, down3])
                                                                            }
                                                                        }
                                                                    }
                                                                }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.trailing, .middle, .outer, .middle],
