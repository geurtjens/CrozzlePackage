                                                                                            ...
                                                                                            for middlex6 in 0..<wordCount {
                                                                                                ...
                                                                                                if (W.Len[middlex6] == interlockWidth &&
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, left2, middlex3, middlex4, outerx5, middlex6, down1, middley2, outery3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
