                                                    ...
                                                    for outerx3 in 0..<wordCount {
                                                        ...
                                                        if W.Len[outerx3] >= interlockWidth + 2 {
                                                            ...
                                                            for outerx3Pos in 1..<outerx3Limit {
                                                                ...
                                                                if (W.Start[outerx3][outerx3Pos + 0] == W.End[up1][0] &&
                                                                W.Start[outerx3][outerx3Pos + 1] == W.Start[down2][2] &&
                                                                W.Start[outerx3][outerx3Pos + 2] == W.End[up3][0] &&
                                                                ...
                                                                W.Id[outerx3] != W.Id[up1]) {
                                                                    ...
                                                                    if phase == 0 {
                                                                        ...
                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, middlex2, outerx3, up1, down2, up3])
                                                                    }
                                                                }
                                                            }
                                                        }
