                                                                                            ...
                                                                                            for middlex5 in 0..<wordCount {
                                                                                                ...
                                                                                                if (W.Len[middlex5] == interlockWidth &&
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [middlex1, outerx2, middlex3, outerx4, middlex5, down1, middley2, outery3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
