                                                                                    ...
                                                                                    for right6 in 0..<wordCount {
                                                                                        ...
                                                                                        if (W.Len[right6] >= interlockWidth &&
                                                                                            ...
                                                                                            if phase == 0 {
                                                                                                ...
                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, right2, middlex3, left4, middlex5, right6, down1, middley2, outery3])
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
