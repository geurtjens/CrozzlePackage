                        ...
                        if (W.Len[middlex1] == interlockWidth &&
                            ...
                            for up2 in 0..<wordCount {
                                ...
                                if (W.Len[up2] >= interlockHeight &&
                                    W.End[up2][2] == W.Start[middlex1][1] &&
                                    ...
                                    for outerx2 in 0..<wordCount {
                                        ...
                                        if W.Len[outerx2] >= interlockWidth + 2 {
                                            ...
                                            for outerx2Pos in 1..<outerx2Limit {
                                                ...
                                                W.Start[outerx2][outerx2Pos + 1] == W.End[up2][1] &&
                                                        ...
                                                        if (W.Len[down3] >= interlockHeight &&
                                                            ...
                                                            for middlex3 in 0..<wordCount {
                                                                ...
                                                                if (W.Len[middlex3] == interlockWidth &&
                                                                    ...
                                                                    W.Start[middlex3][1] == W.End[up2][0] &&
                                                                    ...
                                                                    if phase == 0 {
                                                                        ...
                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [middlex1, outerx2, middlex3, down1, up2, down3])
                                                                    }
                                                                }
                                                            }
                                                        }
