public class C3x5_OMOMO_DUD {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                ...
                                W.Id[outerx1] != W.Id[down1]) {
                                    ...
                                    for up2 in 0..<wordCount {
                                        ...
                                        if (W.Len[up2] >= interlockHeight &&
                                            W.End[up2][4] == W.Start[outerx1][outerx1Pos + 1] &&
                                                            ...
                                                            for outerx3 in 0..<wordCount {
                                                                ...
                                                                if W.Len[outerx3] >= interlockWidth + 2 {
                                                                    ...
                                                                    for outerx3Pos in 1..<outerx3Limit {
                                                                        ...
                                                                        W.Start[outerx3][outerx3Pos + 1] == W.End[up2][2] &&
                                                                                            ...
                                                                                            for outerx5Pos in 1..<outerx5Limit {
                                                                                                ...
                                                                                                W.Id[outerx5] != W.Id[down1]) {
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, outerx3, middlex4, outerx5, down1, up2, down3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.outer, .middle, .outer, .middle, .outer],
