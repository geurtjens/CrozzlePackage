public class C3x5_OMMOM_OMU {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                        ...
                                                                        for outerx4 in 0..<wordCount {
                                                                            ...
                                                                            if W.Len[outerx4] >= interlockWidth + 2 {
                                                                                ...
                                                                                for outerx4Pos in 1..<outerx4Limit {
                                                                                    ...
                                                                                    W.Start[outerx4][outerx4Pos + 2] == W.End[up3][1] &&
                                                                                    ...
                                                                                    W.Id[outerx4] != W.Id[outery1]) {
                                                                                        ...
                                                                                        for middlex5 in 0..<wordCount {
                                                                                            ...
                                                                                            if (W.Len[middlex5] == interlockWidth &&
                                                                                                ...
                                                                                                W.Start[middlex5][2] == W.End[up3][0] &&
                                                                                                ...
                                                                                                if phase == 0 {
                                                                                                    ...
                                                                                                    ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, middlex3, outerx4, middlex5, outery1, middley2, up3])
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.outer, .middle, .middle, .outer, .middle],
