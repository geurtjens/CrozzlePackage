public class C3x6_LRMLRL_MOM {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                                    ...
                                                                                    for left6 in 0..<wordCount {
                                                                                        ...
                                                                                        if (W.Len[left6] >= interlockWidth &&
                                                                                            ...
                                                                                            if phase == 0 {
                                                                                                ...
                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, right2, middlex3, left4, right5, left6, middley1, outery2, middley3])
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.leading, .trailing, .middle, .leading, .trailing, .leading],
