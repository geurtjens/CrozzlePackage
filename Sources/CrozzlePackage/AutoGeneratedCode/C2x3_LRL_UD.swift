                                            ...
                                            for left3 in 0..<wordCount {
                                                ...
                                                if (W.Len[left3] >= interlockWidth &&
                                                    ...
                                                    if phase == 0 {
                                                        ...
                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, right2, left3, up1, down2])
                                                    }
                                                }
                                            }
                                        }
