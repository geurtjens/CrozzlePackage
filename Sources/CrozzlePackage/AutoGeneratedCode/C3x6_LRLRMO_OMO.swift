                                                                                                ...
                                                                                                for outerx6Pos in 1..<outerx6Limit {
                                                                                                    ...
                                                                                                    W.Id[outerx6] != W.Id[outery1]) {
                                                                                                        ...
                                                                                                        if phase == 0 {
                                                                                                            ...
                                                                                                            ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, right2, left3, right4, middlex5, outerx6, outery1, middley2, outery3])
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                            }
