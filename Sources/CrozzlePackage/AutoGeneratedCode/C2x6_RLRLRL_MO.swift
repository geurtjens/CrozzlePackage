                                                                        ...
                                                                        if (W.Len[right5] >= interlockWidth &&
                                                                            ...
                                                                            for left6 in 0..<wordCount {
                                                                                ...
                                                                                if (W.Len[left6] >= interlockWidth &&
                                                                                    W.End[left6][1] == W.Start[middley1][5] &&
                                                                                    W.End[left6][0] == W.Start[outery2][outery2Pos + 5] &&
                                                                                    ...
                                                                                    if phase == 0 {
                                                                                        ...
                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, left2, right3, left4, right5, left6, middley1, outery2])
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
