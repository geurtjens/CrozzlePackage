                                                                                            ...
                                                                                            for left6 in 0..<wordCount {
                                                                                                ...
                                                                                                if (W.Len[left6] >= interlockWidth &&
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, left3, middlex4, right5, left6, middley1, outery2, middley3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
