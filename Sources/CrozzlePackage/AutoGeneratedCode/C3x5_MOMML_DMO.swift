                                                                                    ...
                                                                                    for left5 in 0..<wordCount {
                                                                                        ...
                                                                                        if (W.Len[left5] >= interlockWidth &&
                                                                                            ...
                                                                                            if phase == 0 {
                                                                                                ...
                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [middlex1, outerx2, middlex3, middlex4, left5, down1, middley2, outery3])
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
