                                                                                    ...
                                                                                    for left6 in 0..<wordCount {
                                                                                        ...
                                                                                        if (W.Len[left6] >= interlockWidth &&
                                                                                            ...
                                                                                            if phase == 0 {
                                                                                                ...
                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, middlex2, right3, left4, right5, left6, down1, middley2, outery3])
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
