                                                                                        ...
                                                                                        for outerx6Pos in 1..<outerx6Limit {
                                                                                            ...
                                                                                            W.Id[outerx6] != W.Id[outery1]) {
                                                                                                ...
                                                                                                if phase == 0 {
                                                                                                    ...
                                                                                                    ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, left2, middlex3, right4, middlex5, outerx6, outery1, middley2, up3])
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
