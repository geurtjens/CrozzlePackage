                                                                                            ...
                                                                                            for outerx6Pos in 1..<outerx6Limit {
                                                                                                ...
                                                                                                W.Id[outerx6] != W.Id[down1]) {
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, right2, middlex3, outerx4, middlex5, outerx6, down1, middley2, up3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
