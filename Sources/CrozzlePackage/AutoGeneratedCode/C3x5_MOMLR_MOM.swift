public class C3x5_MOMLR_MOM {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                                    ...
                                                                                    for right5 in 0..<wordCount {
                                                                                        ...
                                                                                        if (W.Len[right5] >= interlockWidth &&
                                                                                            ...
                                                                                            if phase == 0 {
                                                                                                ...
                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [middlex1, outerx2, middlex3, left4, right5, middley1, outery2, middley3])
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.middle, .outer, .middle, .leading, .trailing],
