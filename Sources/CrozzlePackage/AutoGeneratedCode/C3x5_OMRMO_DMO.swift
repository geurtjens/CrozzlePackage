                                                                                            ...
                                                                                            for outerx5Pos in 1..<outerx5Limit {
                                                                                                ...
                                                                                                W.Id[outerx5] != W.Id[down1]) {
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, right3, middlex4, outerx5, down1, middley2, outery3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
