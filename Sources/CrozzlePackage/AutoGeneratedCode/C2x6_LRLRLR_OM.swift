                                                            ...
                                                            if (W.Len[right4] >= interlockWidth &&
                                                                ...
                                                                for left5 in 0..<wordCount {
                                                                    ...
                                                                    if (W.Len[left5] >= interlockWidth &&
                                                                        W.End[left5][1] == W.Start[outery1][outery1Pos + 4] &&
                                                                        W.End[left5][0] == W.Start[middley2][4] &&
                                                                        ...
                                                                        for right6 in 0..<wordCount {
                                                                            ...
                                                                            if (W.Len[right6] >= interlockWidth &&
                                                                                ...
                                                                                if phase == 0 {
                                                                                    ...
                                                                                    ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, right2, left3, right4, left5, right6, outery1, middley2])
                                                                                }
                                                                            }
                                                                        }
                                                                    }
