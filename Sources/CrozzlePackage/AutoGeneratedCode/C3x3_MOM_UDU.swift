                ...
                if (W.Len[up1] >= interlockHeight) {
                    ...
                    for middlex1 in 0..<wordCount {
                        ...
                        if (W.Len[middlex1] == interlockWidth &&
                            W.Start[middlex1][0] == W.End[up1][2] &&
                                    ...
                                    for outerx2 in 0..<wordCount {
                                        ...
                                        if W.Len[outerx2] >= interlockWidth + 2 {
                                            ...
                                            for outerx2Pos in 1..<outerx2Limit {
                                                ...
                                                if (W.Start[outerx2][outerx2Pos + 0] == W.End[up1][1] &&
                                                ...
                                                W.Id[outerx2] != W.Id[up1]) {
                                                    ...
                                                    for up3 in 0..<wordCount {
                                                        ...
                                                        if (W.Len[up3] >= interlockHeight &&
                                                            W.End[up3][2] == W.Start[middlex1][2] &&
                                                            W.End[up3][1] == W.Start[outerx2][outerx2Pos + 2] &&
                                                            ...
                                                            for middlex3 in 0..<wordCount {
                                                                ...
                                                                if (W.Len[middlex3] == interlockWidth &&
                                                                    W.Start[middlex3][0] == W.End[up1][0] &&
                                                                    W.Start[middlex3][1] == W.Start[down2][2] &&
                                                                    W.Start[middlex3][2] == W.End[up3][0] &&
                                                                    ...
                                                                    if phase == 0 {
                                                                        ...
                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [middlex1, outerx2, middlex3, up1, down2, up3])
                                                                    }
                                                                }
                                                            }
                                                        }
