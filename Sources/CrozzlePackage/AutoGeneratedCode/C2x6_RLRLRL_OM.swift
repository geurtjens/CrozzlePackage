                                    ...
                                    if (W.Len[middley2] == interlockHeight &&
                                        ...
                                        for left2 in 0..<wordCount {
                                            ...
                                            if (W.Len[left2] >= interlockWidth &&
                                                W.End[left2][1] == W.Start[outery1][outery1Pos + 1] &&
                                                W.End[left2][0] == W.Start[middley2][1] &&
                                                    ...
                                                    if (W.Len[right3] >= interlockWidth &&
                                                        ...
                                                        for left4 in 0..<wordCount {
                                                            ...
                                                            if (W.Len[left4] >= interlockWidth &&
                                                                W.End[left4][1] == W.Start[outery1][outery1Pos + 3] &&
                                                                W.End[left4][0] == W.Start[middley2][3] &&
                                                                    ...
                                                                    if (W.Len[right5] >= interlockWidth &&
                                                                        ...
                                                                        for left6 in 0..<wordCount {
                                                                            ...
                                                                            if (W.Len[left6] >= interlockWidth &&
                                                                                W.End[left6][1] == W.Start[outery1][outery1Pos + 5] &&
                                                                                W.End[left6][0] == W.Start[middley2][5] &&
                                                                                ...
                                                                                if phase == 0 {
                                                                                    ...
                                                                                    ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, left2, right3, left4, right5, left6, outery1, middley2])
                                                                                }
                                                                            }
                                                                        }
                                                                    }
