                                                                                ...
                                                                                for right5 in 0..<wordCount {
                                                                                    ...
                                                                                    if (W.Len[right5] >= interlockWidth &&
                                                                                        ...
                                                                                        if phase == 0 {
                                                                                            ...
                                                                                            ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [middlex1, outerx2, middlex3, middlex4, right5, outery1, middley2, down3])
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
