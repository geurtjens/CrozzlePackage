                                                                                        ...
                                                                                        for outerx5Pos in 1..<outerx5Limit {
                                                                                            ...
                                                                                            W.Id[outerx5] != W.Id[outery1]) {
                                                                                                ...
                                                                                                if phase == 0 {
                                                                                                    ...
                                                                                                    ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, middlex2, right3, middlex4, outerx5, outery1, middley2, outery3])
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
