                                                                                    ...
                                                                                    for right6 in 0..<wordCount {
                                                                                        ...
                                                                                        if (W.Len[right6] >= interlockWidth &&
                                                                                            ...
                                                                                            if phase == 0 {
                                                                                                ...
                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, middlex3, left4, middlex5, right6, down1, middley2, up3])
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
