public class C3x5_RMOMR_DUD {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                            ...
                                                                            for right5 in 0..<wordCount {
                                                                                ...
                                                                                if (W.Len[right5] >= interlockWidth &&
                                                                                    ...
                                                                                    if phase == 0 {
                                                                                        ...
                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, middlex2, outerx3, middlex4, right5, down1, up2, down3])
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.trailing, .middle, .outer, .middle, .trailing],
