public class C3x5_OMRMO_DUD {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                                    ...
                                                                                    for outerx5Pos in 1..<outerx5Limit {
                                                                                        ...
                                                                                        W.Id[outerx5] != W.Id[down1]) {
                                                                                            ...
                                                                                            if phase == 0 {
                                                                                                ...
                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, right3, middlex4, outerx5, down1, up2, down3])
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.outer, .middle, .trailing, .middle, .outer],
