public class C3x6_OMMOMO_DUD {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                                                    ...
                                                                                                    for outerx6Pos in 1..<outerx6Limit {
                                                                                                        ...
                                                                                                        W.Id[outerx6] != W.Id[down1]) {
                                                                                                            ...
                                                                                                            if phase == 0 {
                                                                                                                ...
                                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, middlex3, outerx4, middlex5, outerx6, down1, up2, down3])
                                                                                                            }
                                                                                                        }
                                                                                                    }
                                                                                                }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.outer, .middle, .middle, .outer, .middle, .outer],
