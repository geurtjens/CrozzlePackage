public class C3x6_OMLRMO_MOM {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                                                    ...
                                                                                                    for outerx6Pos in 1..<outerx6Limit {
                                                                                                        ...
                                                                                                        W.Id[outerx6] != W.Id[middley1]) {
                                                                                                            ...
                                                                                                            if phase == 0 {
                                                                                                                ...
                                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, left3, right4, middlex5, outerx6, middley1, outery2, middley3])
                                                                                                            }
                                                                                                        }
                                                                                                    }
                                                                                                }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.outer, .middle, .leading, .trailing, .middle, .outer],
