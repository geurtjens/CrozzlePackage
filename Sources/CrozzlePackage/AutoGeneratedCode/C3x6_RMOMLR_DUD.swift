public class C3x6_RMOMLR_DUD {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                    ...
                                                    for outerx3 in 0..<wordCount {
                                                        ...
                                                        if W.Len[outerx3] >= interlockWidth + 2 {
                                                            ...
                                                            for outerx3Pos in 1..<outerx3Limit {
                                                                ...
                                                                W.Start[outerx3][outerx3Pos + 1] == W.End[up2][3] &&
                                                                                    ...
                                                                                    for right6 in 0..<wordCount {
                                                                                        ...
                                                                                        if (W.Len[right6] >= interlockWidth &&
                                                                                            ...
                                                                                            if phase == 0 {
                                                                                                ...
                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, middlex2, outerx3, middlex4, left5, right6, down1, up2, down3])
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.trailing, .middle, .outer, .middle, .leading, .trailing],
