public class C3x6_OMRMLR_MOM {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                                            ...
                                                                                            for right6 in 0..<wordCount {
                                                                                                ...
                                                                                                if (W.Len[right6] >= interlockWidth &&
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, right3, middlex4, left5, right6, middley1, outery2, middley3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.outer, .middle, .trailing, .middle, .leading, .trailing],
