                                                                                            ...
                                                                                            for outerx5Pos in 1..<outerx5Limit {
                                                                                                ...
                                                                                                W.Id[outerx5] != W.Id[middley1]) {
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, middlex2, outerx3, middlex4, outerx5, middley1, outery2, middley3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
