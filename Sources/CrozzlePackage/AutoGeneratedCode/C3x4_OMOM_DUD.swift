                                ...
                                W.Id[outerx1] != W.Id[down1]) {
                                    ...
                                    for up2 in 0..<wordCount {
                                        ...
                                        if (W.Len[up2] >= interlockHeight &&
                                            W.End[up2][3] == W.Start[outerx1][outerx1Pos + 1] &&
                                                                            ...
                                                                            for middlex4 in 0..<wordCount {
                                                                                ...
                                                                                if (W.Len[middlex4] == interlockWidth &&
                                                                                    ...
                                                                                    if phase == 0 {
                                                                                        ...
                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, outerx3, middlex4, down1, up2, down3])
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
