                                                            ...
                                                            for right4 in 0..<wordCount {
                                                                ...
                                                                if (W.Len[right4] >= interlockWidth &&
                                                                    ...
                                                                    if phase == 0 {
                                                                        ...
                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [right1, left2, middlex3, right4, down1, up2, down3])
                                                                    }
                                                                }
                                                            }
                                                        }
