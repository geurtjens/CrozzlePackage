                                                                                            ...
                                                                                            for left6 in 0..<wordCount {
                                                                                                ...
                                                                                                if (W.Len[left6] >= interlockWidth &&
                                                                                                    ...
                                                                                                    if phase == 0 {
                                                                                                        ...
                                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, middlex3, outerx4, middlex5, left6, up1, down2, up3])
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
