public class C3x5_OMMRL_DUD {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                            ...
                                                                            for left5 in 0..<wordCount {
                                                                                ...
                                                                                if (W.Len[left5] >= interlockWidth &&
                                                                                    ...
                                                                                    if phase == 0 {
                                                                                        ...
                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, middlex3, right4, left5, down1, up2, down3])
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.outer, .middle, .middle, .trailing, .leading],
