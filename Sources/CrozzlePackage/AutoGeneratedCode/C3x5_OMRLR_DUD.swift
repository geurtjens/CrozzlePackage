public class C3x5_OMRLR_DUD {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                            ...
                                                                            for right5 in 0..<wordCount {
                                                                                ...
                                                                                if (W.Len[right5] >= interlockWidth &&
                                                                                    ...
                                                                                    if phase == 0 {
                                                                                        ...
                                                                                        ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, right3, left4, right5, down1, up2, down3])
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.outer, .middle, .trailing, .leading, .trailing],
