public class C3x6_OMOMOM_DUD {
   static func Execute(W: WordModelSOA, wordCount: Int) -> ClusterModel {
                                                                                                    ...
                                                                                                    for middlex6 in 0..<wordCount {
                                                                                                        ...
                                                                                                        if (W.Len[middlex6] == interlockWidth &&
                                                                                                            ...
                                                                                                            if phase == 0 {
                                                                                                                ...
                                                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [outerx1, middlex2, outerx3, middlex4, outerx5, middlex6, down1, up2, down3])
                                                                                                            }
                                                                                                        }
                                                                                                    }
                                                                                                }
        ...
        return ClusterModel(
            ...
            patternHorizontal: [.outer, .middle, .outer, .middle, .outer, .middle],
