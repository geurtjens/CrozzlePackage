                                                                                        ...
                                                                                        for middlex6 in 0..<wordCount {
                                                                                            ...
                                                                                            if (W.Len[middlex6] == interlockWidth &&
                                                                                                ...
                                                                                                if phase == 0 {
                                                                                                    ...
                                                                                                    ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, right2, middlex3, middlex4, outerx5, middlex6, outery1, middley2, down3])
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
