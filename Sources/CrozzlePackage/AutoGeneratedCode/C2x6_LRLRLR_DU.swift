                                        ...
                                        if (W.Len[right2] >= interlockWidth &&
                                            ...
                                            for left3 in 0..<wordCount {
                                                ...
                                                if (W.Len[left3] >= interlockWidth &&
                                                    W.End[left3][1] == W.Start[down1][2] &&
                                                    W.End[left3][0] == W.End[up2][3] &&
                                                        ...
                                                        if (W.Len[right4] >= interlockWidth &&
                                                            ...
                                                            for left5 in 0..<wordCount {
                                                                ...
                                                                if (W.Len[left5] >= interlockWidth &&
                                                                    W.End[left5][1] == W.Start[down1][4] &&
                                                                    W.End[left5][0] == W.End[up2][1] &&
                                                                    ...
                                                                    for right6 in 0..<wordCount {
                                                                        ...
                                                                        if (W.Len[right6] >= interlockWidth &&
                                                                            ...
                                                                            if phase == 0 {
                                                                                ...
                                                                                ClusterHelper.AddWords(index: &index, wordId: &wordId, wordsToAdd: [left1, right2, left3, right4, left5, right6, down1, up2])
                                                                            }
                                                                        }
                                                                    }
                                                                }
